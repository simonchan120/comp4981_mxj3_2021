...
import os
import pickle
SCENARIOS_OBJ_PATH = 'conversation_lists'
dir_path = os.path.dirname(os.path.realpath(__file__))
sys.path.append(os.path.join(dir_path,'..'))
from word_processing_tools import process_string_name
from dialogue import Scenario,Scenarios
...
def add_data():
    first_time_obj = Scenarios()
    with open(SCENARIOS_OBJ_PATH,'wb')as fp:
        pickle.dump(first_time_obj)
def process_data():
