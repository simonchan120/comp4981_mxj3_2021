...
<p>For a better experience while using our Service, we may require you to provide us with certain
    personally identifiable information, including but not limited to message contents, account id and email address in this application. 
	The information that we request is will be retained by us and used as described in this privacy policy.</p>
<b>We value the confidentiality of these information. 
    ...
    Notice that your data, including but not limited to emotional scores generated by analysis of your data, may be used for providing an overall statistical analysis given to the backstage system of this Service
    for the access of dedicated individuals to monitor the general situation of your community.
    These data will not include any personally identifiable information; they are strictly anonymous when being used for such purpose.</b>
